...
#Net original: -0.69, corrected: -0.22 Conf 95%(-0.40 to -0.03), r^2= 0.049 p= 0.02, corrected slope -0.23
...
z_blom <- z(corrected_correlation)
 ...
 #Resp original: -0.62, corrected: -0.29 Conf 95%(-0.46 to -0.11), r2= 0.086, p= 0.002, corrected slope = -0.33 
...
#gross original: -0.56, corrected: -0.34 Conf 95%(-0.5 to -0.16), r2=0.115 p= 0.0004, corrected slope = -0.34
...
#Calc original: -0.43, corrected: 0.12 Conf 95%(-0.07 to 0.31), r2=0.015 p= 0.2 -> non sig., correc6ted slope = 0.13
```
...
#Net original: -0.73, corrected: -0.65 Conf 95%(-0.79 to -0.46), r2=0.422, p< 0.001, corrected slope = -0.674
...
z_blom <- z(corrected_correlation)
 ...
 #Resp original: -0.50, corrected: -0.25 Conf 95%(-0.49 to 0.03), r2=0.063 p= 0.08 -> non sig., corrected slope = -0.259
...
#gross original: -0.59, corrected: -0.47 Conf 95%(-0.66 to -0.23), r2=0.222 p= 0.0004, corrected slope = -0.486
...
#Calc original: -0.45, corrected: -0.21 Conf 95%(-0.46 to 0.07), r2= 0.045 p= 0.14 -> non sig., corrected slope = -0.137
```
