...
#Calc original: -0.43, corrected: 0.12 Conf 95%(-0.07 to 0.31), p= 0.2 -> non sig.
```
...
b7 <-ggplot(mix, aes(x = exp_Gross_photo_ug_h_cm2, y = exp_obs_gross_photo)) +
  ...
  scale_y_continuous(limits = c(-30, 34), breaks = seq(-30, 30, by = 10))+
      theme_gross
...
#Net original: -0.73, corrected: -0.65 Conf 95%(-0.79 to -0.46), p< 0.001
...
z_blom <- z(corrected_correlation)
 ...
 #Resp original: -0.50, corrected: -0.25 Conf 95%(-0.49 to 0.03), p= 0.08 -> non sig.
...
#gross original: -0.59, corrected: -0.47 Conf 95%(-0.66 to -0.23), p= 0.0004
...
#Calc original: -0.45, corrected: -0.21 Conf 95%(-0.46 to 0.07), p= 0.14 -> non sig.
```
...
ggsave("Graphs/con_mix_gross_expobs_bruno.png", width=13, height= 10, limitsize=FALSE, dpi= 700, expObs_bruno_med_con_mix_gross)
...
ggsave("Graphs/con_rest_expobs_bruno.png", width=10, height= 12, limitsize=FALSE, dpi= 700, expObs_bruno_med_con_rest)
...
ggsave("Graphs/mix_rest_expobs_bruno.png", width=10, height= 12, limitsize=FALSE, dpi= 700, expObs_bruno_med_mix_rest)
